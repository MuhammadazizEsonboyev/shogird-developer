...
export default function DropdownBasic() {
    ...
    return (
        <>
            ...
            <div className="relative inline-flex mt-[23px]" id="dropdown">
                ...
                <ul
                    className={`${isOpen ? "flex" : "hidden"
                        } absolute top-full z-10  flex w-72 list-none flex-col rounded bg-white py-2 shadow-md shadow-slate-500/10 `}
                >
